 ...
 <header class="header">
      <nav class="navbar fixed-top navbar-expand-lg ">
        <div class="container-fluid  gap-2">
          ...
          <a class="navbar-brand order-4" id="" href="../login.php">
          ...
          <div class="collapse navbar-collapse order-3" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                <li class="nav-item">
                  <a class="nav-link" id="" href="../index.php">Home</a>
                </li>
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item" id="churrasqueiras-link" aria-current="page" href="#">Churrasqueiras</a></li>
